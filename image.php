	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			<figure class="wp-block-image">
				 ...
				 */
				$image_size = apply_filters( 'darchitect_attachment_size', 'full' );
		...
		<footer class="entry-footer default-max-width">
			...
			if ( wp_get_post_parent_id( $post ) ) {
				...
				printf(
					...
					esc_html__( 'Published in %s', 'darchitect' ),
			...
			if ( $metadata ) {
				printf(
					...
					esc_html_x( 'Full size', 'Used before full size attachment link.', 'darchitect' ), // phpcs:ignore WordPress.Security.EscapeOutput
